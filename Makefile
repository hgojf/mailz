...
SRCS_IMSG = compat/freezero.c compat/imsg.c compat/imsg-buffer.c
INSTALL ?= install
...
SRCS_CONTENT += compat/base64.c compat/strtonum.c $(SRCS_IMSG)
...
SRCS_MAILZ += compat/strtonum.c compat/warnc.c $(SRCS_IMSG)
...
SRCS_REGRESS += compat/base64.c compat/strtonum.c $(SRCS_IMSG)
...
SRCS_ALL += compat/base64.c compat/freezero.c compat/imsg-buffer.c
SRCS_ALL += compat/imsg.c compat/strtonum.c compat/warnc.c
